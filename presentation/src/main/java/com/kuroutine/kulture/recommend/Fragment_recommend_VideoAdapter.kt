...
class Fragment_recommend_VideoAdapter(var items:ArrayList<YouTubePlayerView>)
    : RecyclerView.Adapter<Fragment_recommend_VideoAdapter.ViewHolder>() {


    inner class ViewHolder(itemView: YouTubePlayerView) : RecyclerView.ViewHolder(itemView) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        return ViewHolder(v as YouTubePlayerView)
